    ...
    children: [
      {
        path: '/homeContainer',
        name: 'homeContainer',
        meta: {path: '/visualPlatform'},
        component: () => import(/* webpackChunkName: "homeContainer" */ '../views/homeContainer.vue'),
        children: [
          {
            path: '/homePage',
            name: 'homePage',
      ...
      },
      {
        path: '/visualPlatform',
        name: 'visualPlatform',
        meta: {path: '/homeContainer'},
        component: () => import(/* webpackChunkName: "visualPlatform" */ '../views/visualPlatform/index.vue'),
      }
    ]
  },
  {
